...
Some fun facts before you play this game:
...
Some fun assumptions you'll make for the game:
1) You are a bird.
...
5) The world is depending on you, Bird!!!! Humans suck but think about your fellow birds (who are nowhere to be found - you are a lone ranger).
...
1) Up arrow moves you upwards
2) Down arrow moves you downwards
3) Left arrow moves you leftwards 
4) Right arrow moves you rightwards
5) Select button takes you back to the introduction (like a restart)
6) Start button (or enter) starts the game -- you'll know when you need to use this.
